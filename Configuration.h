...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-5 Pro
    ...
    #define DEFAULT_Kp_LIST {  20.55,  20.55 }
    #define DEFAULT_Ki_LIST {   1.38,   1.38 }
    #define DEFAULT_Kd_LIST {  76.61,  76.61 }
  #else
    #define DEFAULT_Kp  20.55
    #define DEFAULT_Ki   1.38
    #define DEFAULT_Kd  76.61
  #endif
#endif // PIDTEMP
...
/**
 * The NOZZLE_TO_PROBE_OFFSET probe uses a Hall effect sensor and emulates a servo.
 */
#define BLTOUCH
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -7, -2.55 }
